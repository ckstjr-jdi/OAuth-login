...
public class MemberDao {
    ...
    public MemberVO getMemberDetail(String sociatId) {
        log.info("socialId:"+sociatId);
        //member.xml에 등록된 select문의 아이디값
        MemberVO rmVO = sqlSessionTemplate.selectOne("getMemberDetail",sociatId);
        return rmVO;
