...
public class MemberService {
    ...
    public MemberVO oauthCreate(String socialId, String username
                              , String password, String email, String socialType){
    ...
    public MemberVO login(MemberLoginDto memDto) {
        ...
        //사용자가 입력한 비번과 DB에서 꺼낸 비번을 같은지 비교해야한다.
        //BCryptPasswordEncoderrk가 제공하는 matches():boolean메서드의 파라미터로
